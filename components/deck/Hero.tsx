...
export function Hero() {
  return (
    ...
    >
      ...
      />
      <div
        className="absolute inset-0 bg-[radial-gradient(circle_at_50%_120%,rgba(201,162,74,0.18),transparent_55%)]"
        aria-hidden
      />
      ...
      <div className="relative z-10 flex h-full flex-col items-center justify-center px-6 text-center">
        ...
        <KineticType
          ...
          delay={0.35}
          className="mt-8 max-w-5xl font-display font-light text-[clamp(2.4rem,8vw,7.2rem)] leading-[0.98] tracking-tight text-ivory"
        />

        <Reveal delay={1.1}>
          <p className="mt-8 max-w-xl text-sm text-ivory/70 sm:text-base">
